<?php
// If accessed directly, set up the necessary data
if (!isset($manufacturers) || !isset($specials)) {
    ...
    $specials = get_filtered_products($conn, $manufacturer_ID, $min_price, $max_price, $search, true);
}
?>
