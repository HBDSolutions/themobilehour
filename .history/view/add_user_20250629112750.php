                ...
                <form class="item-form" enctype="multipart/form-data" action="../controller/addnewuser.php" method="POST">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" id="email" name="email" placeholder="Enter user email address (xxxxx@xxxxx)" title="Please enter a valid email address in the format user@example." class="form-control" required autocomplete="off" value="" />
                        </div>
                        <div class="form-group col-md-6">
