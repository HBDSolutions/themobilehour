                        ...
                        <?php foreach ($products as $product): ?>
                            <tr>
                                <td class='cart-image-cell'>
                                    <img src='../assets/images/<?= htmlspecialchars(basename($product['image'])) ?>' alt='Product image' style='width: 80px;'>
                                </td>
                                ...
                                <td class='text-right align-middle' style='vertical-align: top;'>
                                    <a href='../controller/managecart.php?action=remove&id=<?= $product['product_ID'] ?>' class='btn btn-link p-0' title='Remove from cart' style='vertical-align: middle;'>
