            ...
            <form class="item-form" enctype="multipart/form-data" action="/themobilehour/controller/editproduct.php?id=<?php echo $id?>" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" maxlength="16" name="resolution" id="resolution" class="form-control" placeholder="Enter resolution in pixels (e.g., 1080x2400) or WxH format (max 16 characters). Leave blank if unknown"
