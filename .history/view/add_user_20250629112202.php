                ...
                <form class="item-form" enctype="multipart/form-data" action="../controller/addnewuser.php" method="POST">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" id="email" name="email" placeholder="Enter user email address (xxxxx@xxxxx)" class="form-control" required autocomplete="off" value="" />
                        </div>
                        <div class="form-group col-md-6">
                            <label for="password">Password:</label>
                            <input type="password" id="password" name="password" placeholder="Min 8 chars, incl. upper, lower, number, special" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[\W_]).{8,}$" class="form-control" required autocomplete="off" value="" />
                        </div>
                    </div>
